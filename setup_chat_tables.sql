-- Script pour créer les tables de chat
...
COMMENT ON COLUMN chat_messages.type IS 'Type de message: text, image, file, system';

-- Vérifier que les tables ont été créées
SELECT table_name, table_type 
FROM information_schema.tables 
WHERE table_name IN ('chats', 'chat_messages', 'chat_notifications')
ORDER BY table_name;
