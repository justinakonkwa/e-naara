-- =====================================================
-- 🔍 FONCTION POUR RECHERCHE PAR CODE COURT
-- =====================================================

-- Supprimer l'ancienne fonction si elle existe
DROP FUNCTION IF EXISTS search_order_by_short_code(TEXT);

-- Fonction pour rechercher une commande par son code court (8 premiers caractères)
...
-- Test de la fonction
SELECT '✅ Fonction search_order_by_short_code créée avec succès' as message;
