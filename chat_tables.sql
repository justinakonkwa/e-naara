-- Tables pour le système de chat entre client et vendeur
...
-- Politiques pour la table chat_notifications
...
-- Fonctions pour automatiser certaines opérations
...
-- Fonction pour créer une notification de chat (désactivée temporairement)
...
--         notification_user_id := chat_record.seller_id;
--     ELSE
--         notification_user_id := chat_record.customer_id;
--     END IF;
--     
...
-- Trigger pour créer automatiquement les notifications (désactivé temporairement)
...
COMMENT ON TABLE chat_notifications IS 'Table des notifications de chat pour les utilisateurs';
