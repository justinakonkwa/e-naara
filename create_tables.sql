-- =====================================================
-- SCRIPT DE CRÉATION DES TABLES POUR SHOPFLOW
...
-- =====================================================
-- 4. TABLE DES ÉLÉMENTS DU PANIER
-- =====================================================
...
-- =====================================================
-- 8. TABLE DE LA LISTE DE SOUHAITS
-- =====================================================
...
-- Index pour la liste de souhaits
...
BEGIN
    ...
    RAISE NOTICE '✅ Les politiques de sécurité sont configurées';
    RAISE NOTICE '✅ Les index de performance sont créés';
    RAISE NOTICE '✅ Les données de base sont insérées';
    RAISE NOTICE '🎉 Votre base de données ShopFlow est prête !';
END $$;
