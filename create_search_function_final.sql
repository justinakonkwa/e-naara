-- =====================================================
-- 🔍 FONCTION RPC FINALE POUR RECHERCHER PAR CODE COURT
-- =====================================================

-- Supprimer l'ancienne fonction si elle existe
DROP FUNCTION IF EXISTS search_orders_by_short_code(TEXT);

-- Fonction simple pour rechercher par code court
CREATE OR REPLACE FUNCTION search_orders_by_short_code(search_code TEXT)
RETURNS TABLE (
    id UUID,
    user_id UUID,
    product_id TEXT,
...
BEGIN
    ...
    FROM orders o
    WHERE LEFT(o.id::TEXT, 8) = LOWER(search_code)
    LIMIT 1;
END;
$$ LANGUAGE plpgsql SECURITY DEFINER;

-- Donner les permissions nécessaires
GRANT EXECUTE ON FUNCTION search_orders_by_short_code(TEXT) TO authenticated;

-- Test de la fonction
SELECT '✅ Fonction search_orders_by_short_code créée avec succès' as message;

-- Test avec le code court spécifique
SELECT '🔍 Test avec 862d6aae:' as test_message;
